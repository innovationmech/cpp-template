# VcpkgHelpers.cmake Utility functions for vcpkg integration and dependency management
...
# Function to find a package with fallback options Usage: find_package_with_fallback(PackageName
# VCPKG_NAME vcpkg_name SYSTEM_NAME system_name)
...
function(setup_vcpkg_manifest)
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/vcpkg.json")
        ...
        set(VCPKG_MANIFEST_MODE
            ON
            CACHE BOOL "Enable vcpkg manifest mode")
