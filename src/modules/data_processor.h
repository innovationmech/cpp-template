...
public:
     ...
     */
    ProcessingResult processItem(const std::string& input, ProcessingMode mode = ProcessingMode::SIMPLE);
     ...
     */
    ProcessingResult processBatch(const std::vector<std::string>& inputs, ProcessingMode mode = ProcessingMode::BATCH);
