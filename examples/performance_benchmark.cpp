...
public:
    ...
    void printResults() const {
        ...
        std::cout << std::left 
                  ...
                  << std::setw(20) << "Avg per Op (μs)" << std::endl;
        ...
        for (const auto& result : results_) {
            ...
            std::cout << std::left
                      ...
                      << std::setw(20) << std::fixed << std::setprecision(2) << avg_us << std::endl;
        }
        std::cout << std::endl;
    }
...
std::vector<std::string> generateTestData(size_t count, size_t min_length = 5, size_t max_length = 50) {
...
void benchmarkStringUtilities(BenchmarkResults& results) {
    ...
    // Benchmark toUpper
    {
        ...
        std::cout << "toUpper: " << iterations << " operations in " << elapsed << " ms" << std::endl;
    }
    ...
    // Benchmark toLower
    {
        ...
        std::cout << "toLower: " << iterations << " operations in " << elapsed << " ms" << std::endl;
    }
    ...
    // Benchmark split
    {
        ...
        std::cout << "split: " << split_data.size() << " operations in " << elapsed << " ms" << std::endl;
    }
    ...
    // Benchmark join
    {
        ...
        std::cout << "join: " << (iterations / 10) << " operations in " << elapsed << " ms" << std::endl;
    }
...
void benchmarkValidation(BenchmarkResults& results) {
    ...
    // Benchmark isEmpty
    {
        ...
        std::cout << "isEmpty: " << iterations << " operations in " << elapsed << " ms" << std::endl;
    }
    ...
    // Benchmark isAlphanumeric
    {
        ...
        std::cout << "isAlphanumeric: " << iterations << " operations in " << elapsed << " ms" << std::endl;
    }
    ...
    // Benchmark isValidEmail
    {
        ...
        std::cout << "isValidEmail: " << iterations << " operations in " << elapsed << " ms" << std::endl;
    }
...
void benchmarkConcurrency() {
    ...
    std::cout << "  " << total_operations << " operations across " << num_cores << " cores" << std::endl;
    std::cout << "  Total time: " << sequential_time << " ms" << std::endl;
    std::cout << "  Throughput: " << (total_operations / sequential_time * 1000) << " ops/sec" << std::endl;
...
int main() {
    ...
    try {
        ...
        std::cout << "4. Profile with tools like perf, gprof, or Instruments for detailed analysis" << std::endl;
